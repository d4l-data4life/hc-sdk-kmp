...
To ensure Java 8 compatibility, add compile options to app `build.gradle` as well as the provided client configuration information you got after getting in touch with us:
...
NOTE: The CI expects this configuration from environment variables stored in GitHub secrets: `D4L_CLIENT_CONFIG_ANDROID` and `D4L_TEST_CONFIG_ANDROID`
