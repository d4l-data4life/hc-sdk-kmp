...
Additionally you also can create customized Records, which do not relay on the Fhir-Model by the usage of:
...
Additionally you also can fetch customized Records, which do not relay on the Fhir-Model by the usage of:
...
Additionally you also can fetch multiple customized Records, which do not relay on the Fhir-Model by the usage of:
...
Additionally you also can update a customized Records, which do not relay on the Fhir-Model by the usage of:
...
Additionally you also can delete a customized Records, which do not relay on the Fhir-Model by the usage of:
