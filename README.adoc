...
:toc-title:
ifdef::env-github[]
:imagesdir: https://github.com/d4l-data4life/hc-sdk-kmp/blob/main/assets/images/
:link-license: https://github.com/d4l-data4life/hc-sdk-kmp/blob/main/LICENSE
:link-contribution: https://github.com/d4l-data4life/hc-sdk-kmp/blob/main/CONTRIBUTION.adoc
...
<div align="center">
    <!-- PROJECT LOGO -->
    <p>
        <a><img src="https://github.com/d4l-data4life/hc-sdk-kmp/blob/main/assets/images/d4l-logo.svg" width="150"/></a>
    </p>
    <!-- PROJECT HEADER -->
