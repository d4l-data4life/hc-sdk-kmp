...
----
dependencies {
    implementation('com.github.d4l-data4life.hc-sdk-kmp:sdk-jvm:${latestVersion}') {
            exclude group: 'com.github.d4l-data4life.hc-sdk-kmp', module: 'securestore-android'
            exclude group: 'com.github.d4l-data4life.hc-sdk-kmp', module: 'crypto-android'
            exclude group: 'com.github.d4l-data4life.hc-sdk-kmp', module: 'auth-android'
...
----
dependencies {
    implementation('com.github.d4l-data4life.hc-sdk-kmp:sdk-android:${latestVersion}') {
        exclude group: 'com.github.d4l-data4life.hc-sdk-kmp', module: 'securestore-jvm'
        exclude group: 'com.github.d4l-data4life.hc-sdk-kmp', module: 'crypto-jvm'
        exclude group: 'com.github.d4l-data4life.hc-sdk-kmp', module: 'auth-jvm'
...
----
dependencies {
    implementation("com.github.d4l-data4life.hc-sdk-kmp:sdk-jvm:{latestCommitHashOnMain}") {
        ...
    }
}
----
...
----
dependencies {
    implementation("com.github.d4l-data4life.hc-sdk-kmp:sdk-android:{latestCommitHashOnMain}") {
        ...
    }
}
----
