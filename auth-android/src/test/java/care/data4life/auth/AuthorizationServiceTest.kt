...
class AuthorizationServiceTest {
    ...
    companion object {
        ...
        private const val AUTH_STORE_STRING =
            """{"refreshToken":"mockRefreshToken","lastAuthorizationResponse":{"request":{"configuration":{"authorizationEndpoint":"http:\/\/192.168.10.142:8080\/authorize","tokenEndpoint":"http:\/\/192.168.10.142:8080\/token"},"clientId":"android","responseType":"code","redirectUri":"data4life:\/\/","state":"pvh0eYcyno3PycYD40V7Hw","codeVerifier":"jQ0-3_485kOHjCdX_PC8rChb99AvmYxcC4YuMc9YaVSIj3x76u8jZkmsOdcT8qR58I0a87k8seOhhBHflF6y8g","codeVerifierChallenge":"QpwewXdsKSNJipXyhDEtbJj3lAytSaxxUAqcSxGBezQ","codeVerifierChallengeMethod":"S256","additionalParameters":{}},"state":"pvh0eYcyno3PycYD40V7Hw","code":"dehvgDJnTlOrdfVj3ohvMQ","access_token":"mockAccessToken","additional_parameters":{}},"mLastTokenResponse":{"request":{"configuration":{"authorizationEndpoint":"http:\/\/192.168.10.142:8080\/authorize","tokenEndpoint":"http:\/\/192.168.10.142:8080\/token"},"clientId":"android","grantType":"refresh_token","redirectUri":"data4life:\/\/","refreshToken":"mockRefreshToken","additionalParameters":{}},"access_token":"mockAccessToken","refresh_token":"mockRefreshToken","additionalParameters":{}}}"""
