...
== https://github.com/d4l-data4life/hc-sdk-kmp/compare/v1.13.2...main[Unreleased]

=== Added

=== Changed

* Change Securestore to an external dependency link:https://github.com/d4l-data4life/hc-securestore-kmp/[Data4Life Securestore]
